		...
		<caption>
			...
			<div id="derecha">
				<button class="btn btn-secondary glyphicon glyphicon-file" id="btn_id" >
					<a href="http://localhost/programacion_visual_IV/3_parcial/examen_3parcial/administradorRespuestas.php" target="_blank">Mostrar
					</a>
  ...
  $(document).ready(function(){
    $("#btn_id").click(function(){
        ...
        if(ID=="ninguno"){
        	...
        	var url = "http://localhost/programacion_visual_IV/3_parcial/examen_3parcial/componentes/setID.php"
